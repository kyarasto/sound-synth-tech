...
, 			{
				"box" : 				{
					"color" : [ 1.0, 0.188235294117647, 0.188235294117647, 1.0 ],
					"id" : "obj-11",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 90.0, 469.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 260.333333333333371, 390.0, 34.0, 22.0 ],
									"text" : "line~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 90.0, 429.0, 189.5, 22.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 316.0, 176.0, 82.0, 22.0 ],
									"text" : "setrange 0 $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 316.0, 144.0, 39.0, 22.0 ],
									"text" : "/ 127."
								}
...
, 							{
								"box" : 								{
									"addpoints" : [ 234.042553191489361, 0.416588027383411, 0, 335.106382978723389, 0.26876646927962, 0, 691.489361702127667, 0.302362477310183, 0, 994.680851063829778, 0.0, 0, 1000.0, 0.503937005996704, 0 ],
									"id" : "obj-18",
									"maxclass" : "function",
									"numinlets" : 1,
									"numoutlets" : 4,
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 200.0, 276.0, 200.0, 100.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 203.0, 176.0, 84.0, 22.0 ],
									"text" : "set domain $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 90.0, 287.0, 43.0, 22.0 ],
									"text" : "cycle~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "bang" ],
									"patching_rect" : [ 90.0, 243.0, 29.5, 22.0 ],
									"text" : "t f b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 90.0, 155.0, 103.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 316.0, 112.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 203.0, 112.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 90.0, 65.0, 245.0, 22.0 ],
...
,
					"patching_rect" : [ 320.0, 413.0, 116.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 436.0, 490.0, 68.0, 22.0 ],
					"text" : "send~ out2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 320.0, 490.0, 68.0, 22.0 ],
					"text" : "send~ out1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 320.0, 445.0, 54.0, 22.0 ],
					"text" : "*~ 0.707"
				}
